...
class LSTM_Parser:
    ...
    def build(self, summary=False):
        ...
        x=tf.keras.layers.LSTM(self.emb_dim,return_sequences=False, name='LSTM_Stack')(stack_emb)
        y=tf.keras.layers.LSTM(self.emb_dim,return_sequences=False,name='LSTM_Buffer')(buffer_emb)
